<?php die("Access Denied"); ?>#x#a:2:{s:6:"result";a:5:{i:0;O:8:"stdClass":3:{s:4:"link";s:95:"http://virtuemart.net/news/489-virtuemart-3-2-14-security-release-and-enhanced-invoice-handling";s:5:"title";s:66:"VirtueMart 3.2.14 - Security Release and enhanced invoice handling";s:11:"description";s:2465:"<p>This fairly serious XSS discovered by Mattia Furlani pertained only the administration area, so most shops are not affected. Shop owners running a multi-vendor store or fearing that their employees may use this leak should update as soon as possible.</p>
...
<ul><li>Behaviour of the table object is more consistent and reliable.</li>
...
</ul>";}i:3;O:8:"stdClass":3:{s:4:"link";s:62:"http://virtuemart.net/news/486-virtuemart-3-2-8-bugfix-release";s:5:"title";s:33:"VirtueMart 3.2.8 - Bugfix Release";s:11:"description";s:2782:"<p>Unfortunately, we were a bit too fast with our security release, having found an error in the testing phase we created another small bug while we were fixing it.</p>
...
</ul>";}i:4;O:8:"stdClass":3:{s:4:"link";s:94:"http://virtuemart.net/news/482-virtuemart-3-2-6-security-release-and-overhauled-infrastructure";s:5:"title";s:65:"VirtueMart 3.2.6 - Security Release and overhauled infrastructure";s:11:"description";s:4425:"<p>A minor XSS vulnerability was present in versions prior to 3.2.6. It occurred when the features feeds and search were used together. It happened only for feed enabled, so administrators can also close the leak in earlier versions by disabling the feed functions. The URL creation of the feed function used an improper call for JRoute. So urlencoded js was executed. The problem is fixed now by using our getCurrentUrlBy function, which works with a whitelist for variable names and it urlencodes any value.&nbsp;</p>
<div>
<p><a href="http://virtuemart.net/download">DOWNLOAD VM3 NOW<br> VirtueMart 3 component (core and AIO)</a></p>
</div>
