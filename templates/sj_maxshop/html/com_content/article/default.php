				...
				<?php if ($params->get('show_create_date')) : ?>
					...
					<dd class="create">
						...
						<time datetime="<?php echo JHtml::_('date', $this->item->created, 'c'); ?>" >
							<?php echo JText::sprintf( JHtml::_('date', $this->item->created, JText::_('DATE_FORMAT_TEMPLATE'))); ?>
						</time>
					</dd>
				<?php endif; ?>
			...
			<?php if ($params->get('show_publish_date')) : ?>
				...
				<dd class="published">
					...
					<time datetime="<?php echo JHtml::_('date', $this->item->publish_up, 'c'); ?>" itemprop="datePublished">
						<?php echo JText::sprintf('COM_CONTENT_PUBLISHED_DATE_ON', JHtml::_('date', $this->item->publish_up, JText::_('DATE_FORMAT_TEMPLATE'))); ?>
					</time>
				</dd>
			<?php endif; ?>
				...
				<?php if ($params->get('show_modify_date')) : ?>
					...
					<dd class="modified">
						...
						<time datetime="<?php echo JHtml::_('date', $this->item->modified, 'c'); ?>" itemprop="dateModified">
							<?php echo JText::sprintf('COM_CONTENT_LAST_UPDATED', JHtml::_('date', $this->item->modified, JText::_('DATE_FORMAT_TEMPLATE'))); ?>
						</time>
					</dd>
				<?php endif; ?>
