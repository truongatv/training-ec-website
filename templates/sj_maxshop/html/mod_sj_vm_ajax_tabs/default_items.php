...
if ((int)$params->get('pager_display', 1)) {
	...
	<div class="pager-container">
		<ul class="pages">
			<li>
				<a class="page page-previous" href="#<?php echo $item_container; ?>" data-jslide="prev"><i class="fa fa-angle-left"></i> </a>
			</li>
			<li>
				<a class="page page-next" href="#<?php echo $item_container; ?>" data-jslide="next"><i class="fa fa-angle-right"></i></a>
			</li>
		</ul>
	</div>
	<?php
