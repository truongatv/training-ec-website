...
<div class="clearfix"></div>
    ...
    <div class="product-info">
		...
		if (VmConfig::get('ask_question', 0) == 1) {
			...
			?>
			<div class="ask-a-question  form-group">
				<a class="ask-a-question btn btn-info" href="<?php echo $askquestion_url ?>" rel="nofollow" ><?php echo vmText::_('COM_VIRTUEMART_PRODUCT_ENQUIRY_LBL') ?></a>
			</div>
		<?php
		}
		?>
