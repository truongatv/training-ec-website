	...
	<div class="mc-wrap"><!-- Begin mc-wrap -->
		...
		<div class="mc-header">
			<div class="mc-yourcart">
				<?php echo  '<span class="count-item">'.JText::_('YOUR_CART_MINI').'</span><br /><span class="count-price">'.count($cart->products).'<span> '.JText::_('ITEMS').'</span>'.$cart->billTotal.'</span>';
                    //var_dump ($cart->billTotal); die;
                    ?>
			</div>
		</div>
...
<?php echo ($options->product_list_display == 0 && $options->coupon_form_display == 0 && $options->goto_cart_display == 0 && $options->checkout_display == 0 && $options->total_price_display == 0) ? 'display:block!important;' : ''; ?>
}
...
//display:<?php //echo ($options->product_label_display == 1) ? 'block' : 'none;' ?>
}
