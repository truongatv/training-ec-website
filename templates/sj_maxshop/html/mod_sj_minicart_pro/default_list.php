			...
			<div class="mc-product-inner">
				...
				<div class="mc-attribute">
					...
					echo $vm_currency_display->priceDisplay($product->prices['subtotal_with_tax']);
                        ...
                        //var_dump($vm_currency_display);die;
					?>

					</span>
                    <span class="value discount">
					<?php
                        echo $vm_currency_display->priceDisplay($product->prices['discountAmount']);
					...
					<div class="mc-remove"><i class="fa fa-close"></i></div>
<div class="mc-top">

<span class="mc-update-btn"><i class="fa fa-refresh"></i></span>
</div>
				</div>
			</div>
			<div class="clear"></div>
