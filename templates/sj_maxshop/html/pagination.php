...
function pagination_item_active(&$item) {
    ...
    {
        $display = '<i class="fa fa-angle-right l-hiden"></i> <i class="fa fa-angle-left r-hiden"></i>';
    }
    // Check for "Prev" item
    if ($item->text == JText::_('JPREV'))
    {
        $display = '<i class="fa fa-angle-right r-hiden"> </i> <i class="fa fa-angle-left l-hiden"></i>';
    }
