	        ...
	        return array(
				...
				'addr' => array(
					...
					'child' => array(
						...
						'key_text' => array(
							'default' => 'AIzaSyAYvfhU3lQ4Z52FXziEBemhbiXzFycLj7U',
							'name' => JText::_('PLG_SYSTEM_YOUTECH_SHORTCODES_GOOGLE_MAP_KEY'),
							'desc' => JText::_('PLG_SYSTEM_YOUTECH_SHORTCODES_GOOGLE_MAP_KEY_DESC'),
						),
					),
				),
				'width' => array(
					...
					'child' => array(
						...
						'disable_scroll' => array(
							'type'    => 'bool',
							'default' => 'no',
							'name'    => JText::_('PLG_SYSTEM_YOUTECH_SHORTCODES_GOOGLE_MAP_SCROLL'),
							'desc'    => JText::_('PLG_SYSTEM_YOUTECH_SHORTCODES_GOOGLE_MAP_SCROLL_DESC')
						),
					),
				),
	        );
