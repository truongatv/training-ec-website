...
function ShowcaseYTShortcode($atts = null, $content = null) {
	...
	if ( count($slides) ) {
		...
		$return .='</div></div>';
		JHtml::stylesheet(JUri::base()."plugins/system/ytshortcodes/shortcodes/showcase/css/cubeportfolio.min.css");
		JHtml::stylesheet(JUri::base()."plugins/system/ytshortcodes/shortcodes/showcase/css/showcase.css");
