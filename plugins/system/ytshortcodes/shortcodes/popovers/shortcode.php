...
function popoversYTShortcode($atts = null, $content = null) {
	...
	// add stylesheet
	JHtml::stylesheet(JUri::base()."plugins/system/ytshortcodes/assets/css/qtip.css");
	JHtml::stylesheet(JUri::base()."plugins/system/ytshortcodes/shortcodes/popovers/css/popovers.css");
