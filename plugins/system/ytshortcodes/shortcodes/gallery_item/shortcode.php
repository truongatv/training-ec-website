...
function gallery_itemYTShortcode($atts, $content = null){
	global $gwidth, $gheight,$galleryArray,$cation_gallery,$id_uniq,$hover_gallery ;
	$galleryArray[] = array(
	...
	$gallery_item .= "<a title='" . $yt_title . "' href='" . $simage . "' data-rel='prettyPhoto[bkpGallery]'>";
	...
	$gallery_item .= "<img src='" .$simage."' title='" . $yt_title . "' alt='" . $yt_title . "' />";
	$gallery_item .= "</a>";
	$gallery_item .= "<h4 class='item-gallery-title ".$cation_gallery." '>" . parse_shortcode(str_replace(array("<br/>", "<br>", "<br />"), " ", $content)) . "</h4></div>";
	$gallery_item .= "</li>";
