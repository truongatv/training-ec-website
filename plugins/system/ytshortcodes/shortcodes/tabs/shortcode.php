...
function tabsYTShortcode($atts, $content = null){
	...
	$width != '' ? $width : '100%';
	$height != '' ? $height : '150px';
	$css .="#".$id."{width:".$width."; height:".$height."}";
	$doc = JFactory::getDocument();
	$doc->addStyleDeclaration($css);
	$tab = "<div class='yt-tabs ".$type." ".$tabs_style." pull-".$align." yt-clearfix' id='".$id."'><ul class='nav-tabs clearfix'>";
